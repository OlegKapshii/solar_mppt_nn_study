...
fprintf('3. compare_algorithms            - Порівняння алгоритмів на базових сценаріях\n');
fprintf('4. analyze_results               - Аналіз результатів порівняння\n\n');
fprintf('5. nn_advantage_experiments      - Окремий stress-run, де NN можуть явно виграти\n\n');
...
fprintf('└─ 5. Запустіть: nn_advantage_experiments (демо-режим для переваги NN)\n\n');
...
fprintf('├─ neural_network/trained_network_vi_v5.mat - Натренована мережа NN-VI\n');
fprintf('├─ data_generation/training_data.mat     - Дані для тренування NN-GT\n');
fprintf('├─ data_generation/training_data_vi_v5.mat  - Дані для тренування NN-VI\n');
...
fprintf('├─ analysis/analysis_report.txt          - Текстовий звіт базового порівняння\n');
fprintf('└─ analysis/nn_advantage_report.txt      - Текстовий звіт stress-режимів\n\n');

fprintf('═══════════════════════════════════════════════════════════════\n\n');

fprintf('Введіть номер опції (1-5) або натисніть Enter для завершення:\n');
choice = input('> ', 's');
